...
MX_CASES = (
    ...
    BatchGemmCase(
        "v2-rank3-bf16-shared-mxfp8-trans-b-k128",
        batch=4,
        M=32,
        K=128,
        b_batched=False,
    ...
    BatchGemmCase(
        "v2-rank3-shared-mxfp8-a-mxfp8-trans-b-k128",
        batch=4,
        M=32,
        K=128,
        a_batched=False,
    ...
    BatchGemmCase(
        "v1-reduction-bf16-shared-mxfp8-trans-b-k128",
        batch=4,
        M=32,
        K=128,
        b_batched=False,
    ...
    BatchGemmCase(
        "v2-rank3-bf16-mxfp8-mn",
        M=32,
        K=64,
        b_dtype="mxfp8",
    ),
    BatchGemmCase(
        "v2-rank3-bf16-mxfp8-batch16",
        batch=16,
        M=32,
        K=64,
        transpose_b=True,
    ...
    BatchGemmCase(
        "v2-rank3-bf16-mxfp8-partial-b1-e2-of4",
        parent_batch=4,
        batch_begin=1,
        M=32,
        K=64,
    ...
    BatchGemmCase(
        "v2-rank3-mxfp8-mxfp8-accumulate",
        M=32,
        K=64,
        transpose_b=True,
        clear_accum=False,
